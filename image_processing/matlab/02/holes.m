function holes
% holes  finds the  objects number that contains 2 holes  at least.
% clear all variables and close all figures
clear all;
close all;
%  Read Input file: holes.jpg into matrix A
A=imread('holes.jpg');
h1=figure;     imshow(A);  % Show A.
...
h3=figure;
set(h3,'position',[ 66    71   393   267]);   plot(hist(cc_size,50)); title('#pixel & label')
...
msg=strcat(' The Number of objects which contains  at least 2 holes in it is:',num2str(result));
disp( msg);    msgbox(msg) ;